...
namespace Homework1Static
{
    public static class UserDatabase
    {
        ...
        //  static UserDatabase()                               // staticki konstruktor lista users je staticka i pripada samo klasi UserDatabase a ne instanci klase.
        ...
        public static List<User> Search(int? id = null, string name = null, int? age = null)        // ovakav null omogucava da se u pozivu prosledi argument i filtrira samo po njemu
        {
            return Users.Where(user =>                
                (!id.HasValue || user.Id == id.Value) &&                                            // !id.HasValue - proverava da li je vrednost prosledjena metodi a ne da li user.id ima vrednost        
